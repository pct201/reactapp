...
export default class ChangePassword extends Component {
    ...
    render() {
        return (
            <Modal show={this.props.show} aria-labelledby="contained-modal-title-vcenter" centered="true" onHide={this.props.popupClose} backdrop="static">
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="form-group">
                                        ...
                                        placeholder="Old Password" value={this.state.old_password} onChange={this.handleInputChange} />
                                ...
                                <div className="col-md-12 ">
                                    <div className="form-group tooltipContainer">
                                        ...
                                        placeholder="New Password" value={this.state.new_password} onChange={this.handleInputChange} />
                                        <HelpTip message={"New Password must have 6 to 16 length including at least one number and one special character."} />
                                        <span className="errorfont">
                                            {this.validator.message('new_password', this.state.new_password,
                                                ['required', { not_in: [this.state.old_password] }, { regex: /^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/ }],
                                                {
                                                    messages: {
                                                        regex: 'Password must have 6 to 16 length including at least one number and one special character.',
                                                        not_in: 'New password must be different than old password!'
                                                    }
                                                })}
                                        </span>
                                    </div>
                                ...
                                <div className="col-md-12 ">
                                    <div className="form-group">
                                        ...
                                        <span className="errorfont">
                                            {this.validator.message('confirm_password', this.state.confirm_password, 
                                            `required|in:${this.state.new_password}`, { messages: { in: 'Passwords need to match!' } })}
                                        </span>
                                    </div>
                                </div>
                            </div>
